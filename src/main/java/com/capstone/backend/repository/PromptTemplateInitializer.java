...
public class PromptTemplateInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        다음은 한 모의 강의에서 수집된 멀티모달 데이터입니다. 당신의 과제는 이 데이터를 바탕으로, 강사의 강의력을 다음 기준에 따라 체계적으로 평가하는 것입니다.  
       ...
       - [평가 항목 이름] 앞에는 반드시 # 5개와 공백이 한 칸 와야 한다 (이 외에 어떤 것도 [평가 항목 이름] 앞에 와서는 안된다)
       - 점수는 반드시 숫자로만 표현된다.
       - [이유] 앞에는 반드시 @ 5개와 공백이 한 칸 와야 한다 (이 외에 어떤 것도 [이유] 앞에 와서는 안된다)

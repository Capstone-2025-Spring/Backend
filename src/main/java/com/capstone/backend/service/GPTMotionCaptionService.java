...
public class GPTMotionCaptionService {
    ...
    private final String promptTemplate = """
            너는 교육 전문가로서 강의자의 비언어적 표현에 따라 강의를 엄격하게 평가해야한다.
             ...
             다음 조건에 따라 **"가장 오랜 기간 지속되는 "팔짱끼는 중" 혹은 "손 머리에 대는 중" 구간 2개**를 골라 와서 평가하고 아래와 같이 **구조화된 JSON 형식**으로만 출력하라:
             ...
             [
               {
                 ...
                 "endSec": "04",
                 "label": "팔짱을 끼고 있음",
                 "reason": "강의 중 팔짱을 끼는 행위는 폐쇄적인 느낌을 청중에게 전달할 수 있음"
               },
               {
                 "startMin": "01",
                 "startSec": "33",
                 ...
                 "endSec": "39",
                 "label": "손 머리에 대는 중",
                 "reason": "손을 머리에 장기간 댄 채로 발화를 지속하는 것은 올바르지 못한 태도며, 예의에 어긋나는 행동임"
               }
             ]
            """;

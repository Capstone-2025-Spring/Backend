...
from video_caption_generator.utils.feature_extractor import \
    extract_features_from_landmarks
from video_caption_generator.utils.label_map import label_map

##########################################################
# === 모델 로딩 (초기화 시 1회만) ===
MODEL_PATH = "video_caption_generator/model/v1.pt"
CLASSIFIER_PATH = "video_caption_generator/classifier/v1_classifier.py"
##########################################################
